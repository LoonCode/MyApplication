...
//            int fullscreen;
//            try {
//                fullscreen = prefs.getInt(pkgName + PREF_FULLSCREEN, FULLSCREEN_DEFAULT);
//            } catch (ClassCastException ex) {
//                // Legacy boolean setting
//                fullscreen = prefs.getBoolean(pkgName + PREF_FULLSCREEN, false)
//                        ? FULLSCREEN_FORCE : FULLSCREEN_DEFAULT;
//            }
//            final int fullscreenSelection = fullscreen;
//            Spinner spnFullscreen = (Spinner) findViewById(R.id.spnFullscreen);
//            // Note: the order of these items must match the FULLSCREEN_... constants
